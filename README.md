...
10. Ejecuta [`supabase/migration_product_v6_3_scheduled_dates.sql`](supabase/migration_product_v6_3_scheduled_dates.sql) para separar las fechas previstas de los actos procesales de las fechas reales de los abonos.
11. Mantén deshabilitado el registro público de usuarios.
12. La publicación automática configura GitHub Pages desde el flujo incluido en el repositorio.
...
8. Ejecuta `supabase/migration_product_v6_3_scheduled_dates.sql` en SQL Editor.
9. Publica el código actualizado. No inviertas este orden: la aplicación utiliza las vistas y funciones creadas por las migraciones.
...
Para revertir únicamente V6.3, ejecuta [`supabase/migration_product_v6_3_scheduled_dates_rollback.sql`](supabase/migration_product_v6_3_scheduled_dates_rollback.sql).
