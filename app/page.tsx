...
function DocumentDetail({ doc, payments, saving, onClose, onPdf, onShare, onEdit, onDelete, onPayment, onPaymentPdf, onPaymentShare, onDeletePayment, onPaid, onStatusChange }: { doc: Document; payments: Movement[]; saving: boolean; onClose: () => void; onPdf: () => void; onShare: () => void; onEdit: () => void; onDelete: () => void; onPayment: () => void; onPaymentPdf: (payment: Movement) => void; onPaymentShare: (payment: Movement) => void; onDeletePayment: (payment: Movement) => void; onPaid: () => void; onStatusChange: (status: Status) => void }) {
